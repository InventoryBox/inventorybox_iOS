...
//         roundView.layer.cornerRadius = 10
    ...
    private func setchecklistInformations() {
        ...
        let data7 = orderCheckCVCInfo(productimage: "homeIcAble.png", productname: "모카 파우더")
        let data8 = orderCheckCVCInfo(productimage: "homeIcAble.png", productname: "모카 파우더")
        let data9 = orderCheckCVCInfo(productimage: "homeIcAble.png", productname: "모카 파우더")
        let data10 = orderCheckCVCInfo(productimage: "homeIcAble.png", productname: "모카 파우더")
