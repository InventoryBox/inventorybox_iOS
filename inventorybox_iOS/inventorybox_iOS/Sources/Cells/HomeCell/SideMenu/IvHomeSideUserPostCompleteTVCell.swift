//
//  IvHomeSideUserPostCompleteTVCell.swift
//  inventorybox_iOS
//
...
class IvHomeSideUserPostCompleteTVCell: UITableViewCell {
    
    static let identifier : String = "IvHomeSideUserPostCompleteTVCell"
